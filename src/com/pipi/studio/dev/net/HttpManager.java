...
public class HttpManager {
	 ...
	 * 
	 */
	public static String  doGet(String url,List<RequestParameter> parameter,Context context){
		String ret = "";
		try{
			if(null != parameter)
			{
				...
				parameter.add(new RequestParameter("deviceNet",SystemInfoUtils.getNetWorkType(context)));
				parameter.add(new RequestParameter("screenSize",SystemInfoUtils.getScreenSize(context)));
	 ...
	 * 
	 */
	public static String doPost(String reqUrl, HashMap<String, String> hashMap,Context context) {
			...
			if (hashMap != null) {
				hashMap.put("isource", Constants.SOURCE);
				hashMap.put("source", Constants.SOURCE);
				hashMap.put("isLogined","0");
				hashMap.put("hwId", Constants.HWID);
				hashMap.put("serviceCode", Constants.SERVICE_CODE);
				hashMap.put("deviceSystem", Build.VERSION.RELEASE);
				hashMap.put("deviceName", Build.MODEL);
				hashMap.put("deviceNet",SystemInfoUtils.getNetWorkType(context));
				hashMap.put("screenSize",SystemInfoUtils.getScreenSize(context));
